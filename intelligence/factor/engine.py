...
from intelligence.repositories import graph_repo, factor_repo
...
def indicators(industry_id=None, indicator_name=None, symbol=None):
    ...
    return [{
        ...
        "unit": r["unit"], "period": r["period"], "industry": r["industry_name"],
...
def drivers(symbol=None, company_id=None, impact_metric=None):
    ...
    return [{
        ...
        "segment": r.get("segment_name"), "driver_type": r["driver_type"],
...
def run_indicator_impact(indicator_id, new_value=None):
    ...
    from intelligence.repositories import factor_repo as _fr
    if new_value is None:
        inds = _fr.get_indicators(industry_id=None, indicator_name=None)
        latest = None
        for r in inds:
